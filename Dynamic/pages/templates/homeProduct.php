...
<div class="home">
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="product" <!--onclick="window.location='produit.html?id=<?= $produit->getReferenceProduit() ?>'"-->
                            ...
                            <div>
                                ...
                                <div class="buttons">
                                    <a class="cart-add" href="../pages/gestionPanier.php?id=<?= $produit->getReferenceProduit() ?>"><i class="fa fa-cart-plus"></i> Ajouter au panier</a><br>
            ...
            <!--Start Products Home-->
            <!--<div class="col-sm-6 col-md-3">
                <div class="product" onclick="window.location='produit.html'">
        ...
        <a href=""><p class="chemin">Nouveautés...</p></a>
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <div class="product" onclick="window.location='produit.html'">
                    <img src="img/cryaon-de-couleurs-bic.jpg" alt="crayon de couleurs BIC">
